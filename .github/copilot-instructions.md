...
- [Functional Requirements](../docs/functional-requirements.md) - Functional requirements for task management features
- [UI Guidelines](../docs/ui-guidelines.md) - UI and design standards for the application
